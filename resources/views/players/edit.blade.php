    ...
    <div class="row">
        <div class="col-lg-4 col-md-5">
            <div class="card card-user">
                ...
                <div class="content">
                    <div class="author">
                    <img class="avatar border-white" id="pic" src="{{ $players->image }}" alt="Player Image"/>
        ...
        <div class="col-lg-8 col-md-7">
            <div class="card">
                ...
                <div class="content">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="/api/player/image" class="dropzone mb-3" id="filmPicture">
                                {{ csrf_field() }}
                                </form>
                            </div>
                            <div class="col-md-6">
                    ...
                    <form method="POST" action="{{ route('players.update', $players->id) }}">
                        {{ csrf_field() }}
                        {{method_field('PATCH')}}
                        <input type="hidden" name="image" id="picurl" value="{{ $players->image }}">
                        <div class="row">
                             <div class="col-md-12">
